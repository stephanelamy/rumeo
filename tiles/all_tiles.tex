...
\begin{tikzfadingfrompicture}[name=fadingOK]
\node[white] {\scalebox{\scale}{\textbf{\checkmark}}};
\end{tikzfadingfrompicture}
...
\newcommand{\tile}[2]{
    ...
    \filldraw [rounded corners=8pt, fill=olive!17, draw=olive!33, line width=6pt] (0,0) rectangle (2,3);
...
\begin{tikzpicture}[show background rectangle, inner frame sep=0mm]
\filldraw [rounded corners=8pt, fill=olive!17, draw=olive!33, line width=6pt] (0,0) rectangle (2,3);
\marmot[scale=1,xshift=28, yshift=12]
\end{tikzpicture}

\begin{tikzpicture}[show background rectangle, inner frame sep=0mm]
\filldraw [rounded corners=8pt, fill=olive!17, draw=olive!33, line width=6pt] (0,0) rectangle (2,3);
\pig[scale=1,xshift=28, yshift=12]
\end{tikzpicture}

\begin{tikzpicture}[show background rectangle, inner frame sep=0mm]
\filldraw [rounded corners=8pt, fill=olive!17, draw=olive!33, line width=6pt] (0,0) rectangle (2,3);
\panda[scale=1,xshift=28, yshift=12]
\end{tikzpicture}

\begin{tikzpicture}[show background rectangle, inner frame sep=0mm]
\filldraw [rounded corners=8pt, fill=olive!17, draw=olive!33, line width=6pt] (0,0) rectangle (2,3);
\moles[scale=1,xshift=28, yshift=12]
\end{tikzpicture}
